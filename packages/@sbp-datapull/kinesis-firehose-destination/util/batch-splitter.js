module.exports = function (records, callback) {
  ...
  records.forEach(function (record) {
    ...
    if (record.Data.length >= 1000 * 1000) {
      console.error("WARNING, the message size exceeds 1000kb, cannot be sent to Firehose", record.Data.length, record._meta);
      return;
    }

    currentBatch.push(record);
    currentBatchMessagesLength += record.Data.length + record.length;
